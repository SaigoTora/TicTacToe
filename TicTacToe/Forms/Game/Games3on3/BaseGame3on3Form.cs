...
namespace TicTacToe.Forms.Game.Games3on3
{
	internal partial class BaseGame3on3Form : BaseGameForm
	{
		...
		{ InitializeComponent(); }
		internal BaseGame3on3Form(MainForm mainForm, Player player, Bot bot,
		...
		internal BaseGame3on3Form(MainForm mainForm, Player player, CoinReward coinReward,
			RoundManager roundManager, GameMode gameMode, CellType playerCellType,
			bool isTimerEnabled, bool isGameAssistsEnabled)
		...
		internal BaseGame3on3Form(MainForm mainForm, Player player, GameServer gameServer, int coinsBet,
			RoundManager roundManager, GameMode gameMode, CellType playerCellType,
			bool isTimerEnabled, bool isGameAssistsEnabled)
		...
		internal BaseGame3on3Form(MainForm mainForm, Player player, GameClient gameClient, int coinsBet,
			RoundManager roundManager, GameMode gameMode, CellType playerCellType,
			bool isTimerEnabled, bool isGameAssistsEnabled)
