...
namespace TicTacToe.Forms.Game.Games5on5
{
	internal partial class BaseGame5on5Form : BaseGameForm
	{
		...
		{ InitializeComponent(); }
		internal BaseGame5on5Form(MainForm mainForm, Player player, Bot bot,
		...
		internal BaseGame5on5Form(MainForm mainForm, Player player, CoinReward coinReward,
			RoundManager roundManager, GameMode gameMode, CellType playerCellType,
			bool isTimerEnabled, bool isGameAssistsEnabled)
		...
		internal BaseGame5on5Form(MainForm mainForm, Player player, GameServer gameServer, int coinsBet,
			RoundManager roundManager, GameMode gameMode, CellType playerCellType,
			bool isTimerEnabled, bool isGameAssistsEnabled)
		...
		internal BaseGame5on5Form(MainForm mainForm, Player player, GameClient gameClient, int coinsBet,
			RoundManager roundManager, GameMode gameMode, CellType playerCellType,
			bool isTimerEnabled, bool isGameAssistsEnabled)
